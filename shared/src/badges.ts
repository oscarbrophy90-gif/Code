...
export const BADGES: BadgeDef[] = [
  ...
  { id: 'softTouch', name: 'Soft Touch', category: 'finishing', gate: 'layup', description: 'Widens the green window on layups and floaters.', gateThresholds: T(60, 68, 77, 85, 92), cost: T(360, 900, 1900, 3400, 5600), earnedBy: 'layupMake' },
  ...
  { id: 'putbackArtist', name: 'Putback Artist', category: 'finishing', gate: 'rebounding', description: 'Faster gather and better finish off an offensive board.', gateThresholds: T(64, 72, 80, 87, 93), cost: T(400, 1000, 2100, 3700, 6000), earnedBy: 'putback' },
  ...
  { id: 'floorGeneral', name: 'Floor General', category: 'playmaking', gate: 'passing', description: 'Raises teammate grade and assist value in team modes.', gateThresholds: T(65, 73, 81, 88, 94), cost: T(420, 1050, 2200, 3900, 6300), earnedBy: 'assist' },
  { id: 'dimer', name: 'Dimer', category: 'playmaking', gate: 'passing', description: 'Passes out of a drive boost the shooter briefly.', gateThresholds: T(68, 76, 83, 90, 95), cost: T(450, 1130, 2350, 4150, 6700), earnedBy: 'assist' },
  { id: 'needleThreader', name: 'Needle Threader', category: 'playmaking', gate: 'passing', description: 'Tight-window passes complete far more often.', gateThresholds: T(70, 78, 85, 91, 96), cost: T(470, 1180, 2450, 4300, 6900), earnedBy: 'tightPass' },
  ...
  { id: 'boxOut', name: 'Box Out', category: 'defense', gate: 'rebounding', description: 'Better position battles under the rim.', gateThresholds: T(64, 72, 80, 87, 93), cost: T(410, 1030, 2150, 3800, 6100), earnedBy: 'boxOut' },
  { id: 'reboundChaser', name: 'Rebound Chaser', category: 'defense', gate: 'rebounding', description: 'Tracks long caroms and expands your tip range.', gateThresholds: T(66, 74, 82, 89, 94), cost: T(440, 1100, 2300, 4050, 6500), earnedBy: 'rebound' },
